...
<Library LVVersion="19008000">
	...
	<Item Name="Redis Client.lvclass" Type="LVClass" URL="../Redis Client/Redis Client.lvclass"/>
	<Item Name="Redis Pipelining TCP Client.lvclass" Type="LVClass" URL="../Redis Pipelining TCP Client/Redis Pipelining TCP Client.lvclass"/>
	<Item Name="Redis TCP Client.lvclass" Type="LVClass" URL="../Redis TCP Client/Redis TCP Client.lvclass"/>
</Library>
